...
public class MainLayout extends AbstractAppRouterLayout {
    ...
    protected void configure(AppLayout appLayout, AppLayoutMenu menu) {
        setMenuItem(menu, new AppLayoutMenuItem(VaadinIcon.AUTOMATION.create(), RentalPushView.VIEW_TITLE, RentalPushView.VIEW_NAME));
        setMenuItem(menu, new AppLayoutMenuItem(VaadinIcon.BACKSPACE.create(), RentalPullView.VIEW_TITLE, RentalPullView.VIEW_NAME));
